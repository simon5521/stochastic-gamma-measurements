...
class StochasticEventGenerator():
    ...
    def __init__(self,detmodel):
        ...
        self.components.update({ "Orion().TimerKeepAliveReceiveTimeout_3" :
            PeriodicEventSource(
                ...
                "TimoeutKeepAliveReceiveTimeout_3" : {
                #[]
                #[hu.bme.mit.gamma.environment.model.impl.StochasticRuleImpl@4cbf0dc]
                "NewEvent" : 
                ...
                ,"ContRandomVarriableTimerKeepAliveReceiveTimeout_39")
                }
                }
                ,
                portevents = {
        ...
        self.components.update({ "Orion().TimerKapcsolodik_2" :
            PeriodicEventSource(
                ...
                "TimeoutKapcsolodik_2" : {
                #[]
                #[hu.bme.mit.gamma.environment.model.impl.StochasticRuleImpl@1d276fdd]
                "NewEvent" : 
                ContinuousRandomVariable(pyro.distributions.Normal(
                        self.timerMean[0],
                        torch.tensor(0.5
                ...
                ,"ContRandomVarriableTimerKapcsolodik_210")
                }
                }
                ,
                portevents = {
        ...
        self.components.update({ "Orion().TimerZarva_0" :
            PeriodicEventSource(
                ...
                "TimeoutZarva_0" : {
                #[]
                #[hu.bme.mit.gamma.environment.model.impl.StochasticRuleImpl@35cc54a7]
                "NewEvent" : 
                ContinuousRandomVariable(pyro.distributions.Normal(
                        self.timerMean[0],
                        torch.tensor(0.5
                ...
                ,"ContRandomVarriableTimerZarva_011")
                }
                }
                ,
                portevents = {
        ...
        self.components.update({ "Orion().TimerKeepAliveSendTimeout_1" :
            PeriodicEventSource(
                ...
                "TimeoutKeepAliveSendTimeout_1" : {
                #[]
                #[hu.bme.mit.gamma.environment.model.impl.StochasticRuleImpl@45880523]
                "NewEvent" : 
                ContinuousRandomVariable(pyro.distributions.Normal(
                        self.timerMean[0],
                        torch.tensor(0.5
                ...
                ,"ContRandomVarriableTimerKeepAliveSendTimeout_112")
                }
                }
                ,
                portevents = {
        ...
        self.components.update({ "Orion().TimerKeepAliveReceiveTimeout_4" :
            PeriodicEventSource(
                ...
                "TimeoutKeepAliveReceiveTimeout_4" : {
                #[]
                #[hu.bme.mit.gamma.environment.model.impl.StochasticRuleImpl@74f60344]
                "NewEvent" : 
                ContinuousRandomVariable(pyro.distributions.Normal(
                        self.timerMean[0],
                        torch.tensor(0.5
                ...
                ,"ContRandomVarriableTimerKeepAliveReceiveTimeout_413")
                }
                }
                ,
                portevents = {
        ...
        self.components.update({ "Orion().TimerKapcsolodik_3" :
            PeriodicEventSource(
                ...
                "TimeoutKapcsolodik_3" : {
                #[]
                #[hu.bme.mit.gamma.environment.model.impl.StochasticRuleImpl@54034428]
                "NewEvent" : 
                ContinuousRandomVariable(pyro.distributions.Normal(
                        self.timerMean[0],
                        torch.tensor(0.5
                ...
                ,"ContRandomVarriableTimerKapcsolodik_314")
                }
                }
                ,
                portevents = {
        ...
        self.components.update({ "Orion().TimerKeepAliveSendTimeout_0" :
            PeriodicEventSource(
                ...
                "TimeoutKeepAliveSendTimeout_0" : {
                #[]
                #[hu.bme.mit.gamma.environment.model.impl.StochasticRuleImpl@3ccc2fe]
                "NewEvent" : 
                ContinuousRandomVariable(pyro.distributions.Normal(
                        self.timerMean[0],
                        torch.tensor(0.5
                ...
                ,"ContRandomVarriableTimerKeepAliveSendTimeout_015")
                }
                }
                ,
                portevents = {
    ...
    def reset(self):
        ...
        for dist in self.dists:
            dist.reset()
        stochmodel.timerMean[0]=pyro.sample("param_0",pyro.distributions.Uniform(
