...
class StochasticEventGenerator():
    ...
    def reset(self):
        ...
        stochmodel.timerMean=pyro.sample("param_0",pyro.distributions.Uniform(
            low=torch.tensor(4.0),high=torch.tensor(6.0))).item()
        self.detmodel.reset(self.timerMean)
        ...
        self.components.update({ "Orion().TimerKeepAliveReceiveTimeout_3" :
            PeriodicEventSource(
                ...
                "TimoeutKeepAliveReceiveTimeout_3" : {
                #[]
                #[hu.bme.mit.gamma.environment.model.impl.StochasticRuleImpl@2feff143]
                "NewEvent" : 
                ContinuousRandomVariable(pyro.distributions.Normal(
                        torch.tensor(stochmodel.timerMean
                        ),
                        torch.tensor(0.5
                        )
                )
                ,"ContRandomVarriableTimerKeepAliveReceiveTimeout_327")
                }
                }
                ,
                portevents = {
        ...
        self.components.update({ "Orion().TimerKapcsolodik_2" :
            PeriodicEventSource(
                ...
                "TimeoutKapcsolodik_2" : {
                #[]
                #[hu.bme.mit.gamma.environment.model.impl.StochasticRuleImpl@23fca31d]
                "NewEvent" : 
                ContinuousRandomVariable(pyro.distributions.Normal(
                        torch.tensor(stochmodel.timerMean
                        ),
                ...
                ,"ContRandomVarriableTimerKapcsolodik_228")
                }
                }
                ,
                portevents = {
        ...
        self.components.update({ "Orion().TimerZarva_0" :
            PeriodicEventSource(
                ...
                "TimeoutZarva_0" : {
                #[]
                #[hu.bme.mit.gamma.environment.model.impl.StochasticRuleImpl@7499c1a5]
                "NewEvent" : 
                ContinuousRandomVariable(pyro.distributions.Normal(
                        torch.tensor(stochmodel.timerMean
                        ),
                ...
                ,"ContRandomVarriableTimerZarva_029")
                }
                }
                ,
                portevents = {
        ...
        self.components.update({ "Orion().TimerKeepAliveSendTimeout_1" :
            PeriodicEventSource(
                ...
                "TimeoutKeepAliveSendTimeout_1" : {
                #[]
                #[hu.bme.mit.gamma.environment.model.impl.StochasticRuleImpl@79aec8c0]
                "NewEvent" : 
                ContinuousRandomVariable(pyro.distributions.Normal(
                        torch.tensor(stochmodel.timerMean
                        ),
                ...
                ,"ContRandomVarriableTimerKeepAliveSendTimeout_130")
                }
                }
                ,
                portevents = {
        ...
        self.components.update({ "Orion().TimerKeepAliveReceiveTimeout_4" :
            PeriodicEventSource(
                ...
                "TimeoutKeepAliveReceiveTimeout_4" : {
                #[]
                #[hu.bme.mit.gamma.environment.model.impl.StochasticRuleImpl@557a09ff]
                "NewEvent" : 
                ContinuousRandomVariable(pyro.distributions.Normal(
                        torch.tensor(stochmodel.timerMean
                        ),
                ...
                ,"ContRandomVarriableTimerKeepAliveReceiveTimeout_431")
                }
                }
                ,
                portevents = {
        ...
        self.components.update({ "Orion().TimerKapcsolodik_3" :
            PeriodicEventSource(
                ...
                "TimeoutKapcsolodik_3" : {
                #[]
                #[hu.bme.mit.gamma.environment.model.impl.StochasticRuleImpl@348f0a0]
                "NewEvent" : 
                ContinuousRandomVariable(pyro.distributions.Normal(
                        torch.tensor(stochmodel.timerMean
                        ),
                ...
                ,"ContRandomVarriableTimerKapcsolodik_332")
                }
                }
                ,
                portevents = {
        ...
        self.components.update({ "Orion().TimerKeepAliveSendTimeout_0" :
            PeriodicEventSource(
                ...
                "TimeoutKeepAliveSendTimeout_0" : {
                #[]
                #[hu.bme.mit.gamma.environment.model.impl.StochasticRuleImpl@5b20e3d3]
                "NewEvent" : 
                ContinuousRandomVariable(pyro.distributions.Normal(
                        torch.tensor(stochmodel.timerMean
                        ),
                ...
                ,"ContRandomVarriableTimerKeepAliveSendTimeout_033")
                }
                }
                ,
                portevents = {
