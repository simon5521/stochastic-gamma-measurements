		...
		self.components.update({ "Orion().TimerKeepAliveReceiveTimeout_3" :
			PeriodicEventSource(
				...
				rules = {"TimoeutKeepAliveReceiveTimeout_3" : {
					#[]
					#[hu.bme.mit.gamma.environment.model.impl.StochasticRuleImpl@7f33cf83]
					"NewEvent" : 
					ContinuousRandomVariable(pyro.distributions.Normal(loc=torch.tensor(5.0),scale=torch.tensor(0.5)),"ContRandomVarriableTimerKeepAliveReceiveTimeout_31269")
				}}
				,
				portevents = {
		...
		self.components.update({ "Orion().TimerKapcsolodik_2" :
			PeriodicEventSource(
				...
				rules = {"TimeoutKapcsolodik_2" : {
					#[]
					#[hu.bme.mit.gamma.environment.model.impl.StochasticRuleImpl@6d57cf27]
					"NewEvent" : 
					ContinuousRandomVariable(pyro.distributions.Normal(loc=torch.tensor(5.0),scale=torch.tensor(0.5)),"ContRandomVarriableTimerKapcsolodik_21270")
				}}
				,
				portevents = {
		...
		self.components.update({ "Orion().TimerZarva_0" :
			PeriodicEventSource(
				...
				rules = {"TimeoutZarva_0" : {
					#[]
					#[hu.bme.mit.gamma.environment.model.impl.StochasticRuleImpl@2cd70972]
					"NewEvent" : 
					ContinuousRandomVariable(pyro.distributions.Normal(loc=torch.tensor(5.0),scale=torch.tensor(0.5)),"ContRandomVarriableTimerZarva_01271")
				}}
				,
				portevents = {
				"TimeoutZarva_0" : [
		...
		self.components.update({ "Orion().TimerKeepAliveSendTimeout_1" :
			PeriodicEventSource(
				...
				rules = {"TimeoutKeepAliveSendTimeout_1" : {
					#[]
					#[hu.bme.mit.gamma.environment.model.impl.StochasticRuleImpl@34a2c0d1]
					"NewEvent" : 
					ContinuousRandomVariable(pyro.distributions.Normal(loc=torch.tensor(5.0),scale=torch.tensor(0.5)),"ContRandomVarriableTimerKeepAliveSendTimeout_11272")
				}}
				,
				portevents = {
		...
		self.components.update({ "Orion().TimerKeepAliveReceiveTimeout_4" :
			PeriodicEventSource(
				...
				rules = {"TimeoutKeepAliveReceiveTimeout_4" : {
					#[]
					#[hu.bme.mit.gamma.environment.model.impl.StochasticRuleImpl@40e620d3]
					"NewEvent" : 
					ContinuousRandomVariable(pyro.distributions.Normal(loc=torch.tensor(5.0),scale=torch.tensor(0.5)),"ContRandomVarriableTimerKeepAliveReceiveTimeout_41273")
				}}
				,
				portevents = {
		...
		self.components.update({ "Orion().TimerKapcsolodik_3" :
			PeriodicEventSource(
				...
				rules = {"TimeoutKapcsolodik_3" : {
					#[]
					#[hu.bme.mit.gamma.environment.model.impl.StochasticRuleImpl@54e65935]
					"NewEvent" : 
					ContinuousRandomVariable(pyro.distributions.Normal(loc=torch.tensor(5.0),scale=torch.tensor(0.5)),"ContRandomVarriableTimerKapcsolodik_31274")
				}}
				,
				portevents = {
		...
		self.components.update({ "Orion().TimerKeepAliveSendTimeout_0" :
			PeriodicEventSource(
				...
				rules = {"TimeoutKeepAliveSendTimeout_0" : {
					#[]
					#[hu.bme.mit.gamma.environment.model.impl.StochasticRuleImpl@d8ede1]
					"NewEvent" : 
					ContinuousRandomVariable(pyro.distributions.Normal(loc=torch.tensor(5.0),scale=torch.tensor(0.5)),"ContRandomVarriableTimerKeepAliveSendTimeout_01275")
				}}
				,
				portevents = {
