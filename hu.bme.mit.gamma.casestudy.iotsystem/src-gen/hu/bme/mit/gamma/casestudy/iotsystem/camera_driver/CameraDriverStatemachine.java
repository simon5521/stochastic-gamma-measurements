...
public class CameraDriverStatemachine {
	...
	private void changeState() {
		boolean _533991952 = (this.main == Main.CarIsVisible);
		boolean _1426843852 = (this.main == Main.CarIsNotVisible);
		boolean _guard_1913496974 = ((((((_533991952) && ((this.main == Main.CarIsVisible)))) && (this.Traffic_carLeaves_In))));
		if (_guard_1913496974) {
			this.main = Main.CarIsNotVisible;
		}
		boolean _guard_178436968 = ((((((_533991952) && ((this.main == Main.CarIsVisible)))) && (this.Requests_newEvent_In))));
		if (_guard_178436968) {
		...
		boolean _guard_2004204969 = ((((((_1426843852) && ((this.main == Main.CarIsNotVisible)))) && (this.Traffic_carArrives_In))));
		if (_guard_2004204969) {
			this.main = Main.CarIsVisible;
		}
		boolean _guard_1324363116 = ((((((_1426843852) && ((this.main == Main.CarIsNotVisible)))) && (this.Requests_newEvent_In))));
		if (_guard_1324363116) {
			this.Images_newData_Out_blurred = 0.0;
