...
public class ChannelStatechartStatemachine {
	...
	private void changeState() {
		boolean _1504302419 = (this.orionDisconnRegion == OrionDisconnRegion.IdleOrionDisconn);
		boolean _guard_1055893828 = ((((((_1504302419) && ((this.orionDisconnRegion == OrionDisconnRegion.IdleOrionDisconn)))) && (this.Input_OrionDisconn_In))));
		if (_guard_1055893828) {
			this.Output_OrionDisconn_Out = true;
			this.orionDisconnRegion = OrionDisconnRegion.IdleOrionDisconn;
		}
		boolean _guard_76857946 = ((((((_1504302419) && ((this.orionDisconnRegion == OrionDisconnRegion.IdleOrionDisconn)))) && (this.Input_OrionDisconnCause_In))));
		if (_guard_76857946) {
			this.Output_OrionDisconnCause_Out = true;
			this.orionDisconnRegion = OrionDisconnRegion.IdleOrionDisconn;
		}
		boolean _guard_374568846 = ((((((_1504302419) && ((this.orionDisconnRegion == OrionDisconnRegion.IdleOrionDisconn)))) && (this.Input_OrionConnReq_In))));
		if (_guard_374568846) {
			this.Output_OrionConnReq_Out = true;
			this.orionDisconnRegion = OrionDisconnRegion.IdleOrionDisconn;
		}
		boolean _guard_1286469441 = ((((((_1504302419) && ((this.orionDisconnRegion == OrionDisconnRegion.IdleOrionDisconn)))) && (this.Input_OrionAppData_In))));
		if (_guard_1286469441) {
			this.Output_OrionAppData_Out = true;
			this.orionDisconnRegion = OrionDisconnRegion.IdleOrionDisconn;
		}
		boolean _guard_830758283 = ((((((_1504302419) && ((this.orionDisconnRegion == OrionDisconnRegion.IdleOrionDisconn)))) && (this.Input_OrionKeepAlive_In))));
		if (_guard_830758283) {
			this.Output_OrionKeepAlive_Out = true;
			this.orionDisconnRegion = OrionDisconnRegion.IdleOrionDisconn;
		}
		boolean _guard_426278083 = ((((((_1504302419) && ((this.orionDisconnRegion == OrionDisconnRegion.IdleOrionDisconn)))) && (this.Input_OrionConnConf_In))));
		if (_guard_426278083) {
			this.Output_OrionConnConf_Out = true;
			this.orionDisconnRegion = OrionDisconnRegion.IdleOrionDisconn;
		}
		boolean _guard_2007398644 = ((((((_1504302419) && ((this.orionDisconnRegion == OrionDisconnRegion.IdleOrionDisconn)))) && (this.Input_OrionConnResp_In))));
		if (_guard_2007398644) {
