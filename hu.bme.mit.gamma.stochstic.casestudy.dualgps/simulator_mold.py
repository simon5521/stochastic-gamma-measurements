	...
	def __init__(self,detmodel):
		...
		self.components.update({ "_GPS1_Failure" :
			EventSource(
				...
				rules = {
				"Faults" : {
				#[hu.bme.mit.gamma.environment.model.impl.StochasticRuleImpl@ec168c5]
				#
				"Failure" : 
		...
		self.components.update({ "_GPS2_Failure" :
			EventSource(
				...
				rules = {
				"Faults" : {
				#[hu.bme.mit.gamma.environment.model.impl.StochasticRuleImpl@2b1e184e]
				#
				"Failure" : 
		...
		self.components.update({ "_Voter_Failure" :
			EventSource(
				...
				rules = {
				"Faults" : {
				#[hu.bme.mit.gamma.environment.model.impl.StochasticRuleImpl@7d4b0cf2]
				#
				"Failure" : 
